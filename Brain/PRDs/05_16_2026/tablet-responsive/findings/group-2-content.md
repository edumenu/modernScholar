...
- **P3** Author bio card at the end of the post is full-width with a small avatar; visually balanced but the "Catherine Dumenu / Scholarship Advisor" type stack at 14/12px feels small relative to the body type. Visible in `blog-post-tablet-portrait-light.png`.
