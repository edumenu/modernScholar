// --- Profile store and match scoring ---
// Commented out: depends on ScholarshipCategory which was removed in the
// seasonal scholarship display rewrite. Will be reinstated when profile
// matching is rebuilt with the new education-level-based data model.
