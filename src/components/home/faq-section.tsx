...
const faqs: FAQItem[] = [
  ...
  {
    question:
      "How do you decide which scholarships make it onto Modern Scholar?",
    answer:
      "Every scholarship is hand-reviewed by our team before it's listed. We verify the provider, confirm the application link is live, and tag the eligibility criteria accurately — so you can spend your time applying instead of vetting listings.",
  },
  {
