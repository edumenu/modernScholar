...
/* ──────────────────────────────────────────────
   FEATURE CARD — fades in and slides up on scroll
   Each card is staggered by its index so they
  ...
  return (
    <section id="features" className="relative py-32 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        {/* Feature grid — staggered scroll reveal, cards fade in + slide up one by one */}
